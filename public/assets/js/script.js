			...
			'<ul class="sticky-sidebar">' +
				'<li class="sidebar-icons">' +
					'<a href="#" class="add-setting" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Tooltip on left">' +
						'<img src="'+window.location.origin+'/assets/img/icons/sidebar-icon-01.svg" class="feather-five" alt="">' +
					'</a>' +
				'</li>' +
				// '<li class="sidebar-icons">' +
		...
		'<div class="sidebar-settings preview-toggle">' +
			'<div class="sidebar-content sticky-sidebar-one">' +
				'<div class="sidebar-header">' +
					...
					'<a class="sidebar-close" href="#"><img src="'+window.location.origin+'/assets/img/icons/close-icon.svg" alt=""></a>' +
				'</div>' +
							...
							'<div class="layout-wrap">' +								
								'<div class="d-flex align-items-center">' +
									'<div class="status-toggle d-flex align-items-center me-2">' +
										...
										'<label for="1" class="checktoggle"><a  href="#"class="layout-link">checkbox</a> </label>' + 
									'</div>' +
